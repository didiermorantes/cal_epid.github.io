...
//Se genera una tabla por cada més
    ...
    mes.style="height:auto;background-color:lightblue; background-image: url('img/logo_ins_200px.png'); background-repeat: no-repeat;  background-position:right center; position: relative;";
    document.body.appendChild(mes);
    //Tabla
    let tabla_mes = document.createElement("table");
