...
//Se genera una tabla por cada més
    ...
    mes.style="height:auto;background-color:lightblue; background-image: url('img/logo-ins_blanco_negro_125.jpg'); background-repeat: no-repeat;  background-position:center center; position: relative;";
    document.body.appendChild(mes);
    //Tabla
    let tabla_mes = document.createElement("table");
